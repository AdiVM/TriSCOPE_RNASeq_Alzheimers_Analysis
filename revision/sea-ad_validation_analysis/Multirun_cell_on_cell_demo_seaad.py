...
log_dir_path = "/n/groups/patel/adithya/Alz_Outputs/Final_Outputs/Multirun_cell_on_cell_demographics_seaad/"
...
def run_single_split(exp_type, cell_type, split_index):
    ...
    train_data = train_metadata[['Donor ID', 'Sex', 'broad_cell_type', 'alzheimers_or_control', 'Age at Death', 'PMI'] + apoe_genotype_columns].copy()
    test_data = test_metadata[['Donor ID', 'Sex', 'broad_cell_type', 'alzheimers_or_control', 'Age at Death', 'PMI'] + apoe_genotype_columns].copy()
