#!/bin/bash
#SBATCH --job-name=ein_apoe_rosmap
...
python3 /home/adm808/Revision_nat_comms/fresh_later/rosmap_427/ein_Multirun_cell_on_cell_genes_apoe_rosmap.py --exp_type "$experiment" --cell_type "$ct" --split_index "$split_number"
#--cell_type "$ct"
