...
def run_single_split(exp_type, cell_type, split_index):
    ...
    gene_matrix = pd.read_parquet(f'/n/groups/patel/adithya/ROSMAP427_Outputs/ROSMAP427_Matrix_{cell_type}').set_index('TAG')
    ...
    del gene_matrix  # not used after the split; free RAM before RFECV (helps Inh's ~264k cells)
    ...
    automl_settings = {
        ...
        "eval_method": 'cv',
        "split_type": 'group',
        "groups": train_metadata['Donor ID'],
