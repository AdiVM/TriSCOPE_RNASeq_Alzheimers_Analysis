...
log_dir_path = "/n/groups/patel/adithya/Alz_Outputs/Final_Outputs/Multirun_cell_on_cell_genes_apoe_rosmap427/"
...
def run_single_split(exp_type, cell_type, split_index):
    ...
    cols_to_drop = ['DonorID', 'Sex', 'broad_cell_type', 'AgeatDeath', 'PMI']
