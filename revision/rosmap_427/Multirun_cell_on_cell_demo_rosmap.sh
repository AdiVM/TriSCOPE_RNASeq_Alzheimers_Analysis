#!/bin/bash
#SBATCH --job-name=demo_rosmap
#SBATCH --output=/n/scratch/users/a/adm808/slurm_logs/demo_%J.out
#SBATCH --error=/n/scratch/users/a/adm808/slurm_logs/demo_%J.err
#SBATCH --nodes=1
...
python3 /home/adm808/Revision_nat_comms/fresh_later/rosmap_427/Multirun_cell_on_cell_demo_rosmap.py --exp_type "$experiment" --cell_type "$ct" --split_index "$split_number"
#--cell_type "$ct"
