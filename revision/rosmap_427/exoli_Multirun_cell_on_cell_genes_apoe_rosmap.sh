#!/bin/bash
#SBATCH --job-name=exoli_apoe_rosmap
#SBATCH --output=/n/scratch/users/a/adm808/slurm_logs/apoe_%J.out
#SBATCH --error=/n/scratch/users/a/adm808/slurm_logs/apoe_%J.err
#SBATCH --nodes=1
...
python3 /home/adm808/Revision_nat_comms/fresh_later/rosmap_427/exoli_Multirun_cell_on_cell_genes_apoe_rosmap.py --exp_type "$experiment" --cell_type "$ct" --split_index "$split_number"
#--cell_type "$ct"
