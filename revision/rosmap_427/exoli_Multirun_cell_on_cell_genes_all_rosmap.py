...
log_dir_path = "/n/groups/patel/adithya/Alz_Outputs/Final_Outputs/Multirun_cell_on_cell_genes_demographics_rosmap427/"
...
def run_single_split(exp_type, cell_type, split_index):
    ...
    train_data = train_matrix_filtered.merge(
        train_metadata[['Donor ID', 'Sex', 'broad_cell_type', 'alzheimers_or_control', 'Age at Death', 'Education', 'PMI'] + apoe_genotype_columns],
        left_index=True,
        right_index=True,
        how='inner'
    )
    ...
    test_data = test_matrix_filtered.merge(
        test_metadata[['Donor ID', 'Sex', 'broad_cell_type', 'alzheimers_or_control', 'Age at Death', 'Education', 'PMI'] + apoe_genotype_columns],
        left_index=True,
        right_index=True,
        how='inner'
    )
