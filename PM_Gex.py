# Predictive Modeling on just Gene Expression data.
import argparse
import os
import pandas as pd
import numpy as np
...
def run_single_split(exp_type, cell_type, split_index):
    ...
    #gene_matrix = pd.read_parquet('/home/adm808/NormalizedCellMatrixSyn16780177.parquet').T
    ...
    # Dropping columns from the dataset
    metadata_cols = ['sample', 'cts_mmse30_lv', 'pmi', 'msex', 'broadcelltype', 'alzheimers_or_control', 'age_death', 'educ']
    import re
